...
my $options = { 'm' => 'localhost', 's' => 'localhost', 'r' => 3306, 'w' => 1000, 'c' => 5000 , 'u' => 'root', 'k' => '/var/lib/mysql/mysql.sock', 'p' => 'password'};
...
(c) 2008 Modified for better Nagios and DRBD integration by Mark Barger <mark\@anywebcam.com>.
INFO
exit;
}
